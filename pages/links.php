...
<HEAD>
<TITLE><?php echo LINK_TITLE.' | '.SITE_TITLE; ?></TITLE>
<?php
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb links_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/links.php" rel="v:url" property="v:title" >'.LINK_TITLE.'</A>
		</li>
	</ul>
</div>
<div id="main">
'.Util::GetActiveLinksList().'
</div></div>
'.Util::PageGetBottom().'
</BODY>
</HTML>';