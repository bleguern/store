 ...
 */
	...
	try {
		...
		$current = $data->ItemTypeGet($id);
		$_REQUEST['item_type_name'] = $current[1];
...
?>
    ...
    $('#submit').click(function () {
        ...
        var id = $('input[id=id]');
        var item_type_name = $('input[id=item_type_name]');
            
        //Simple validation to make sure user entered something
        //If error found, add hightlight class to the text field
        if (item_type_name.val()=='') {
        	item_type_name.addClass('missingvalue');
        	checkProblem = true;
        	missingFields = true;
        } else item_type_name.removeClass('missingvalue');
        ...
        var data = 'id=' + id.val() + '&item_type_name=' + item_type_name.val();
        ...
        $.ajax({
            ...
            url: "_admin_item_type_update.php",
            //GET method is used
            type: "GET",
            //pass the data        
            data: data,
    ...
    $('#delete').click(function () {
		...
		var answer = confirm("<?php echo ITEM_TYPE_DELETE_QUESTION; ?>")
        ...
        $.ajax({
            //this is the php file that processes the data and send mail
            url: "_admin_item_type_delete.php",
            //GET method is used
            type: "GET",
            //pass the data        
            data: data,
            ...
            success: function (html) {
                ...
                item_type_name.attr('disabled', 'disabled');
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb admin_item_type_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_item_type.php" rel="v:url" property="v:title" >'.ITEM_TYPE_LIST_TITLE.'</A>
		</li>
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><span class="title"><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_item_type_update.php?id='.$id.'" rel="v:url" property="v:title" >'.ITEM_TYPE_UPDATE_TITLE.'</A></span> | <a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_item_type_add.php" >'.ITEM_TYPE_ADD_TITLE.'</A>
		</li>
	</ul>
</div>
<div id="main">
<form method="POST" action="_admin_item_type_update.php">
	  	<TABLE>
			<TR>
				<TD>
					<TABLE>
						<TR>
							...
							<TD>
								<INPUT TYPE="text" ID="item_type_name" NAME="item_type_name" VALUE="'.$_REQUEST['item_type_name'].'" STYLE="width:200px" MAXLENGTH="50">
							</TD>
						</TR>
					</TABLE>
				<TD>
			...
			<TR>
				<TD>
					<TABLE class="normal">
						...
						<TR>
							<TD>
								<INPUT TYPE="submit" ID="submit" NAME="submit" VALUE="'.ITEM_TYPE_UPDATE_UPDATE.'" ALT="'.ITEM_TYPE_UPDATE_UPDATE.'">
								<INPUT TYPE="submit" ID="delete" NAME="delete" VALUE="'.ITEM_TYPE_DELETE_DELETE.'" ALT="'.ITEM_TYPE_DELETE_DELETE.'">
