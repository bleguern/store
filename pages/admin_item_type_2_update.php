 ...
 */
	...
	try {
		...
		$current = $data->ItemType2Get($id);
		$_REQUEST['item_type_2_name'] = $current[1];
...
?>
    ...
    $('#submit').click(function () {
        ...
        var data = 'id=' + id.val() + '&item_type_2_name=' + item_type_2_name.val();
        ...
        $.ajax({
            ...
            url: "_admin_item_type_2_update.php",
            //GET method is used
            type: "GET",
            //pass the data        
            data: data,
    ...
    $('#delete').click(function () {
		...
		var answer = confirm("<?php echo ITEM_TYPE_2_DELETE_QUESTION; ?>")
        ...
        $.ajax({
            //this is the php file that processes the data and send mail
            url: "_admin_item_type_2_delete.php",
            //GET method is used
            type: "GET",
            //pass the data        
            data: data,
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb admin_item_type_2_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><span class="title"><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_item_type_2_update.php?id='.$id.'" rel="v:url" property="v:title" >'.ITEM_TYPE_2_UPDATE_TITLE.'</A></span> | <a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_item_type_2_add.php" >'.ITEM_TYPE_2_ADD_TITLE.'</A>
		</li>
	</ul>
</div>
<div id="main">
<form method="POST" action="_admin_item_type_2_update.php">
	  	<TABLE>
			<TR>
				<TD>
					<TABLE>
						<TR>
							...
							<TD>
								<INPUT TYPE="text" ID="item_type_2_name" NAME="item_type_2_name" VALUE="'.$_REQUEST['item_type_2_name'].'" STYLE="width:200px" MAXLENGTH="50">
							</TD>
						</TR>
					</TABLE>
				<TD>
			...
			<TR>
				<TD>
					<TABLE class="normal">
						...
						<TR>
							<TD>
								<INPUT TYPE="submit" ID="submit" NAME="submit" VALUE="'.ITEM_TYPE_2_UPDATE_UPDATE.'" ALT="'.ITEM_TYPE_2_UPDATE_UPDATE.'">
								<INPUT TYPE="submit" ID="delete" NAME="delete" VALUE="'.ITEM_TYPE_2_DELETE_DELETE.'" ALT="'.ITEM_TYPE_2_DELETE_DELETE.'">
