...
?>
    ...
    $('#submit').click(function () {
        ...
        var menu_item_type_2_select = $('select[id=menu_item_type_select_2]');
        ...
        var data = 'menu_name=' + menu_name.val() + '&menu_access=' + menu_access.val() +
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                menu_item_type_select_2.attr('disabled', 'disabled');
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb admin_menu_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><span class="title"><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_menu_add.php" rel="v:url" property="v:title" >'.ADMIN_MENU_ADD_TITLE.'</A></span>
		</li>
	</ul>
</div>
<div id="main">
<form method="POST" action="_admin_menu_add.php">
	  	<TABLE>
			<TR>
				<TD>
					<TABLE>
						<TR>
							...
							<TD>
								<INPUT TYPE="text" ID="menu_name" NAME="menu_name" VALUE="" STYLE="width:200px" MAXLENGTH="100">
							</TD>
						</TR>
					</TABLE>
				<TD>
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="menu_link" NAME="menu_link" VALUE="" STYLE="width:300px" MAXLENGTH="200">
							</TD>
						</TR>
					</TABLE>
				<TD>
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="menu_target" NAME="menu_target" VALUE="_self" STYLE="width:100px" MAXLENGTH="20">
							</TD>
						</TR>
					</TABLE>
				<TD>
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="menu_level_0" NAME="menu_level_0" VALUE="" STYLE="width:50px" MAXLENGTH="3">
							</TD>
						</TR>
					</TABLE>
				<TD>
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="menu_level_1" NAME="menu_level_1" VALUE="" STYLE="width:50px" MAXLENGTH="3">
							</TD>
						</TR>
					</TABLE>
				<TD>
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="menu_style" NAME="menu_style" VALUE="" STYLE="width:150px" MAXLENGTH="50">
							</TD>
						</TR>
					</TABLE>
				<TD>
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>';
			$menu_item_type_selected = '';
		
			echo '<select id="menu_item_type_select" name="menu_item_type_select" onChange="javascript:updateSelect(\'menu_item_type_select\')">';
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="menu_image" NAME="menu_image" VALUE="" STYLE="width:150px" MAXLENGTH="50">
							</TD>
						</TR>
					</TABLE>
				<TD>
			...
			<TR>
				<TD class="max_separator">
					<input type="hidden" id="menu_access" name="menu_access" value="">
					<input type="hidden" id="menu_item_type" name="menu_item_type" value="">
				</TD>
			</TR>
			<TR>
				<TD>
					<TABLE class="normal">
						...
						<TR>
							<TD>
								<INPUT TYPE="submit" ID="submit" NAME="submit" VALUE="'.ADMIN_MENU_ADD_ADD.'" ALT="'.ADMIN_MENU_ADD_ADD.'">
