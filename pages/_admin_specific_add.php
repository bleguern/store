...
/* V1.0 : 20131126 */
	...
	try {
		$result = $data->AdminSpecificAdd($table_name, $values);
	    
	    $data->AdminSaveLog('ADMIN_'.strtoupper($table_name).'_ADDED', 'ID : '.$result);
		echo constant('ADMIN_'.strtoupper($table_name).'_ADDED');
