...
?>
    ...
    $('#submit').click(function () {
        ...
        var data = 'site_theme_code=' + site_theme_code.val() + '&site_theme_name=' + site_theme_name.val();
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb admin_site_theme_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><span class="title"><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_site_theme_add.php" rel="v:url" property="v:title" >'.ADMIN_SITE_THEME_ADD_TITLE.'</A></span>
		</li>
	</ul>
</div>
<div id="main">
<form method="POST" action="_admin_site_theme_add.php">
	  	<TABLE>
			<TR>
				<TD>
					<TABLE>
						<TR>
							...
							<TD>
								<INPUT TYPE="text" ID="site_theme_code" NAME="site_theme_code" VALUE="" STYLE="width:200px" MAXLENGTH="4">
							</TD>
						</TR>
					</TABLE>
				<TD>
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="site_theme_name" NAME="site_theme_name" VALUE="" STYLE="width:300px" MAXLENGTH="50">
							</TD>
						</TR>
					</TABLE>
				<TD>
			...
			<TR>
				<TD>
					<TABLE class="normal">
						...
						<TR>
							<TD>
								<INPUT TYPE="submit" ID="submit" NAME="submit" VALUE="'.ADMIN_SITE_THEME_ADD_ADD.'" ALT="'.ADMIN_SITE_THEME_ADD_ADD.'">
