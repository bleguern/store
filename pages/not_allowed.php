...
<HEAD>
<TITLE><?php echo ERROR_RIGHT.' | '.SITE_TITLE; ?></TITLE>
<?php
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb padlock_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/not_allowed.php" rel="v:url" property="v:title" >'.ERROR_RIGHT.'</A>
		</li>
	</ul>
</div>
<div id="main">
