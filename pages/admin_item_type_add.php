...
?>
    ...
    $('#submit').click(function () {
        ...
        var data = 'item_type_name=' + item_type_name.val();
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb admin_item_type_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><span class="title"><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_item_type_add.php" rel="v:url" property="v:title" >'.ITEM_TYPE_ADD_TITLE.'</A></span>
		</li>
	</ul>
</div>
<div id="main">
<form method="POST" action="_admin_item_type_add.php">
	  	<TABLE>
			<TR>
				<TD>
					<TABLE>
						<TR>
							...
							<TD>
								<INPUT TYPE="text" ID="item_type_name" NAME="item_type_name" VALUE="" STYLE="width:200px" MAXLENGTH="50">
							</TD>
						</TR>
					</TABLE>
				<TD>
			...
			<TR>
				<TD>
					<TABLE class="normal">
						...
						<TR>
							<TD>
								<INPUT TYPE="submit" ID="submit" NAME="submit" VALUE="'.ITEM_TYPE_ADD_ADD.'" ALT="'.ITEM_TYPE_ADD_ADD.'">
