...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb admin_specific_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><span class="title"><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_configuration.php" rel="v:url" property="v:title" >'.ADMIN_ADMIN_CONFIGURATION_LIST_TITLE.'</A></span> | <a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_configuration_add.php">'.ADMIN_ADMIN_CONFIGURATION_ADD_TITLE.'</A>
		</li>
	</ul>
</div>
<div id="main">
<TABLE>
	<TR>
		<TD>'.Util::AdminGetConfigurationList().'</TD>
	</TR>
</TABLE>
</div></div>
'.Util::PageGetBottom().'
