...
?>
    ...
    $('#submit').click(function () {
        ...
        var data = 'admin_version_number=' + admin_version_number.val() + '&admin_version_name=' + admin_version_name.val() +
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb admin_version_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><span class="title"><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_version_add.php" rel="v:url" property="v:title" >'.ADMIN_VERSION_ADD_TITLE.'</A></span>
		</li>
	</ul>
</div>
<div id="main">
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD>
								<INPUT TYPE="text" ID="admin_version_number" NAME="admin_version_number" VALUE="" STYLE="width:100px" MAXLENGTH="10">
							</TD>
						</TR>
						<TR>
						...
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="admin_version_name" NAME="admin_version_name" VALUE="" STYLE="width:200px" MAXLENGTH="50">
							</TD>
						</TR>
						<TR>
							<TD class="max_separator"></TD>
						...
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="admin_version_date" NAME="admin_version_date" VALUE=""><img src="../images/index/calendar_little.gif" id="admin_version_date_button" onclick="javascript:showDateCalendar();">
							</TD>
						</TR>
						<TR>
							<TD class="max_separator"></TD>
						...
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD><textarea cols="60" rows="10" ID="admin_version_description" NAME="admin_version_description"></textarea></TD>
						</TR>
						<TR>
							<TD class="max_separator"></TD>
						</TR>
			...
			<TR>
				<TD>
					<TABLE class="normal">
						...
						<TR>
							<TD>
								<INPUT TYPE="submit" ID="submit" NAME="submit" VALUE="'.ADMIN_VERSION_ADD_ADD.'" ALT="'.ADMIN_VERSION_ADD_ADD.'">
