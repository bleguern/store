...
?>
    ...
    $('#submit').click(function () {
        ...
        var data = 'order_status_name=' + order_status_name.val() + '&order_status_active=' + order_status_active.val() + '&order_status_inventory_reserve=' + order_status_inventory_reserve.val()
        ...
        $.ajax({
            ...
            url: "_admin_order_status_add.php",
            //GET method is used
            type: "GET",
            //pass the data        
            data: data,
            ...
            success: function (html) {
                ...
                order_status_name.attr('disabled', 'disabled');
                order_status_active_select.attr('disabled', 'disabled');
                order_status_inventory_reserve_select.attr('disabled', 'disabled');
                order_status_inventory_cleanup_select.attr('disabled', 'disabled');
                order_status_lock_select.attr('disabled', 'disabled');
                order_status_other_possible_status.attr('disabled', 'disabled');
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb admin_order_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><span class="title"><a href="'.$_SESSION[SITE_ID]['admin_configuration_http'].$_SESSION[SITE_ID]['admin_configuration_site_name'].'/pages/admin_order_status_add.php" rel="v:url" property="v:title" >'.ADMIN_ORDER_STATUS_ADD_TITLE.'</A></span>
		</li>
	</ul>
</div>
<div id="main">
<form method="POST" action="_admin_order_status_add.php">
	  	<TABLE>
			<TR>
				<TD>
					<TABLE>
						<TR>
							...
							<TD>
								<INPUT TYPE="text" ID="order_status_name" NAME="order_status_name" VALUE="" STYLE="width:300px" MAXLENGTH="50">
							</TD>
						</TR>
					</TABLE>
				<TD>
				...
				<TD>
					<TABLE>
						<TR>
							...
							<TD class="field_separator"></TD>
							<TD>
								<INPUT TYPE="text" ID="order_status_other_possible_status" NAME="order_status_other_possible_status" VALUE="" STYLE="width:100px" MAXLENGTH="20">
							</TD>
						</TR>
					</TABLE>
				<TD>
			...
			<TR>
				<TD>
					<TABLE class="normal">
						...
						<TR>
							<TD>
								<INPUT TYPE="submit" ID="submit" NAME="submit" VALUE="'.ADMIN_ORDER_STATUS_ADD_ADD.'" ALT="'.ADMIN_ORDER_STATUS_ADD_ADD.'">
