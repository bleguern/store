...
<HEAD>
<TITLE><?php echo SEARCH.' | '.SITE_TITLE; ?></TITLE>
<?php
...
<div id="title" xmlns:v="http://rdf.data-vocabulary.org/#">
	<ul class="crumb item_crumb" itemprop="breadcrumb">
		...
		<li typeof="v:Breadcrumb" >
			<span class="arrow">></span><a href="'.BASE_LINK.'/search/index.php?query='.$query.'" title="'.SEARCH.' : '.urldecode($query).'" rel="v:url" property="v:title" >'.SEARCH.' : '.urldecode($query).'</A>
		</li>
	</ul>
</div>
<div id="main">
'.UtilSpecific::Search(urldecode($query)).'
</div></div>
'.Util::PageGetBottom().'
</BODY>
</HTML>';