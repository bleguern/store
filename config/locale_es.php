...
define ('PLEASE_CONNECT_BEFORE_CREATE_ORDER', 'Please login or register to create an order!');
define ('PLEASE_CONNECT_BEFORE_LIST_ORDER', 'Please login or register to list your orders!');
...
define ('ADMIN_CONFIGURATION_MANAGER_ADDRESS_TELEPHONE', 'Telephone');
...
define ('ADMIN_CONFIGURATION_ITEM_COMMENT_ENABLED', 'Enabled item comment');
define ('ADMIN_CONFIGURATION_BLOG_COMMENT_ENABLED', 'Enabled blog comment');
...
include_once($root.'./config/locale_es_specific.php');
?>